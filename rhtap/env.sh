...
export GITOPS_REPO_URL=https://github.com/tnevrlka-rhtap/zx6jgfpuw-go-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-s7jtz.s7jtz.sandbox1085.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-s7jtz.s7jtz.sandbox1085.opentlc.com}
